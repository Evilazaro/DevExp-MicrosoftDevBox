...
output devCenterProjectName string = projectName
output devCenterProjectCatalogInfo object = projectCatalogInfo
output devCenterProjectCatalogCatalogName string = projectCatalogInfo.catalogName
output projectResource object = project
